...
<div class='relative flex items-center lg:flex-row flex-col justify-center lg:w-[88%] w-[90%] lg:h-[240px] py-4 bg-indigo-600 rounded-xl mx-auto my-10'>
    <div class="absolute bg-[url('/assets/newsletter_bg.png')] bg-cover w-full h-full"></div>
    <div class="relative w-full flex items-center lg:flex-row flex-col justify-between px-6 lg:px-40">
        <div class="flex flex-col lg:w-[468px] lg:mr-6">
