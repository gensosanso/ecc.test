            ...
            <section class="mx-auto w-full bg-white p-6">
                ...
                <form v-else class="flex flex-col w-full py-3 px-4" @submit.prevent="store()">
                    ...
                    <div class="w-full mt-3">
                        ...
                        <div class="relative mt-1">
                            <input v-model="user.password"
                                class="border-gray-300 border form-input py-2 pr-10 outline-none block rounded-lg shadow-sm w-full"
                                :type="showPassword ? 'text' : 'password'" placeholder="8+ caracteres" />
                    ...
                    <button type="submit" :disabled="loading"
                        class="p-2 mt-8 rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 disabled:bg-blue-300 text-white font-semibold cursor-pointer flex items-center justify-center">
                        <Spin v-if="loading" />
